...
async function main() {
  ...
  console.log("Deploying (v12: mint() deferred-credit CEI fix) with account:", deployer.address);
  ...
  console.log("");
  console.log("Deploying StaxVault (v12)...");
  ...
  console.log("  StaxVault (v12):", await vault.getAddress());
  console.log("");
  ...
  console.log("");
  console.log("=== V12 DEPLOYMENT COMPLETE ===");
  console.log("NEW StaxVault address:", await vault.getAddress());
  console.log("Changes in this version vs v11:");
  console.log("  - mint() now uses deferred-credit CEI: basketTickerHoldings writes");
  console.log("    happen in a second pass, after ALL swaps complete, instead of");
  console.log("    interleaved per-ticker. Flagged by Slither (reentrancy-eth),");
  console.log("    confirmed non-exploitable under nonReentrant via second-model");
  console.log("    review, fixed anyway so mint and redeem share one CEI invariant.");
  console.log("  Carried over from v11 (unchanged):");
