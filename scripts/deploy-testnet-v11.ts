...
async function main() {
  ...
  console.log("Deploying (v11: valueReturnedUsd on Redeemed) with account:", deployer.address);
  ...
  console.log("");
  console.log("Deploying StaxVault (v11)...");
  ...
  console.log("  StaxVault (v11):", await vault.getAddress());
  console.log("");
  ...
  console.log("");
  console.log("=== V11 DEPLOYMENT COMPLETE ===");
  console.log("NEW StaxVault address:", await vault.getAddress());
  console.log("Changes in this version vs v10:");
  console.log("  - Redeemed event now emits valueReturnedUsd: the real, oracle-priced");
  console.log("    USD value of stock assets redeemed, symmetric to Minted's");
  console.log("    valueReceivedUsd. Enables real USD-denominated realized P&L in the");
  console.log("    frontend without approximating from current ETH/USD spot price.");
  console.log("  Carried over from v10 (unchanged):");
