...
async function main() {
  ...
  console.log("Deploying (v10: correct team wallet) with account:", deployer.address);
  ...
  console.log("");
  console.log("Deploying StaxVault (v10)...");
  ...
  console.log("  StaxVault (v10):", await vault.getAddress());
  console.log("");
  ...
  console.log("");
  console.log("=== V10 DEPLOYMENT COMPLETE ===");
  console.log("NEW StaxVault address:", await vault.getAddress());
  console.log("Changes in this version vs v9:");
  console.log("  - teamWallet is now the REAL, correct team wallet address, not the");
  console.log("    deployer. v9 (and every prior version) hardcoded deployer.address");
  console.log("    as both owner AND team wallet -- meaning 50% of every mint/redeem");
  console.log("    fee would have flowed to the deployer wallet, not the intended");
  console.log("    team wallet. teamWallet is immutable, so this could only be fixed");
  console.log("    by a fresh deploy, not a post-deploy admin call.");
  console.log("  Carried over from v9 (unchanged):");
  console.log("  - MIN_INITIAL_VALUE_USD = $5 (genesis mint floor)");
  console.log("  - redeem() two-pass CEI structure (closes read-only reentrancy window)");
  console.log("");
