...
// On-chain numeric basket IDs, per the original deploy script.
const BASKETS = [
...
// real margin, so this works whether a basket is totally empty or already
// has some dust-level supply from earlier testing.
