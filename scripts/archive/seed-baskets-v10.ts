...
const VAULT_ADDRESS = "0x62C641739c2317b740F5A18904311f5c4aD0DDb7"; // v10

// On-chain numeric basket IDs, per deploy-testnet-v10.ts.
const BASKETS = [
...
// ~$450 at $3000/ETH -- comfortably above the $2 genesis floor (v10),
// with real margin, so this works whether a basket is totally empty
// (true here, v10 is fresh) or already has some dust-level supply.
...
async function main() {
  ...
  console.log("");
  console.log("=== SEEDING COMPLETE (v10) ===");
}
