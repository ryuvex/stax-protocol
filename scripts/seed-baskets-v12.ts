...
const VAULT_ADDRESS = "0xF3cE0386FEf1cE4493bEd00caDE0A00D783666a6"; // v12 (confirmed)
...
const SEED_AMOUNT_ETH = "0.02"; // $2 genesis floor -- small amount is plenty
...
async function main() {
  ...
  console.log("");
  console.log("=== SEEDING COMPLETE (v12) ===");
}
